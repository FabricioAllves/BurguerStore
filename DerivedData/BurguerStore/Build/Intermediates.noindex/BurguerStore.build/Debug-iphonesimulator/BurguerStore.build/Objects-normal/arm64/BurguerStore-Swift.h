...
#ifndef BURGUERSTORE_SWIFT_H
#define BURGUERSTORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BurguerStore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12BurguerStore11AppDelegate")
...
SWIFT_CLASS("_TtC12BurguerStore18HomeViewController")
...
SWIFT_CLASS("_TtC12BurguerStore13SceneDelegate")
...
SWIFT_CLASS("_TtC12BurguerStore20SignInViewController")
@interface SignInViewController : UIViewController
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)dismissKeyboard:(UITapGestureRecognizer * _Nonnull)view;
- (void)sendDidTap:(UIButton * _Nonnull)sender;
- (void)regiterDidTap:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12BurguerStore20SignUpViewController")
